...
- [ ] I made a pr with structure, review it now
...
#### Standups 
- [ ] how frequent (minverva says daily)
- [ ] online/off
...
- [ ] requirements gathering (what it means?, how to perform?)
- [ ] personas with clear impact on all parts of the system 
...
- [ ] testing strategy
    ...
    - [ ] tests (coverage and integration tests) (discuss?)
...
- next meeting 
    ...
    - [ ] who books location for next meeting (sprint 2)
    - [ ] who minutes 
